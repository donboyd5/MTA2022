...
-   In the Economic & Revenue Outlook released with the executive budget, DOB gives historical estimates and a budget-year forecast of MTOAF tax revenue for individual taxes, some of which is estimated at the account level. DOB does not appear to give all MTOAF receipts numbers, but rather just tax receipts.

-   With minor exceptions historical tax numbers match OSC numbers. The latest, for 2022-23 is [here](https://www.budget.ny.gov/pubs/archive/fy23/ex/ero/fy23ero.pdf). The 2023-24 version will be out by February 1. We should be able to construct full MTOAF estimates from that.
