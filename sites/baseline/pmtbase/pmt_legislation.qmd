...
-   Here are key provisions from the act [@Chapter25Laws2009], in new sections 800-803 of the Tax Law (I have not copied below some of the administrative provisions). You can find a good summary in the Tax Department's Technical Services Bulletin Memorandum [@MCTMTMetropolitanCommuter2009]. Note that (1) there was a de minimis employer threshold for taxation (\$2,500 in a quarter), (2) federal, interstate, and similar employers were exempt, but there was no exemption for school districts (however, see next bullet), (3) the tax rate was a flat 0.034% for all, and (4) self-employed individuals with net self-employment earnings below \$10,000 are excluded from paying tax.
