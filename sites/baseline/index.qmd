...
-   [Analysis of increasing PMT by \$700m, or raising top rate to 0.0050](options/pmt_increase_dec2022.qmd)

-   [PMT implementation timing](options/pmt_implementation.qmd)

-   PMT state replacement (i.e., offset) analysis

-   [PMT self-employment payors](options/pmt_self_employment_tax.qmd)

-   [MTOA](mtoa/mtoa.qmd)

-   [questions from 1/27/2023](misc/misc.qmd) call (Corp franchise tax increase, casino revenue, UI tax)

## Current High Priorities:

-   From 1/27/2023 phone call
...
-   Section 18-b quick review of Reinvent Albany report, don't spend much time on it; update 18-b calculations to use the state subsidy breakdown that Steve W. provided

-   MTOA (1) Process from collection by Tax Dept to deposit in MTOA, and (2) Tracking MTOA revenue sources

-   How many self-employed under PMT?
