...
-   PMT \~ 2 or so pages addressing impact of PMT, starting with simplest approach

    -   How large is the PMT relative to selected other taxes?

        -   as share of the economy (MTA corporate surcharge, NYS and NYC corporate taxes)

        -   rates relative to other payroll taxes (table comparing rates of payroll taxes (FICA, FUTA, unemployment, PMT; make note of caps on payroll, and any substantial credits against tax; give links to sources)

    -   What happened to employment in MTA region after imposition of PMT?

        -   compared to NYS, and compared to a of MTA-neighboring counties combined (NY, NJ, CT) -- new, simple table or graph

        -   the same pre-post comparison of MTA counties and non-MTA neighbors as before, but add links to data for the graphs

    -   How much does the PMT worsen NY's tax ranking - what would happen to NY's ranking (state and local taxes relative to the economy) if the PMT did not exist?

-   TCJA and MTA taxes

    -   How much did NY-ers save federally as a result of the pass-through entity tax? How does that compare to the size of a hypothetical PMT increase?
