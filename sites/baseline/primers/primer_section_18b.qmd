...
-   What's its history - when and how did the state start paying MTA with MTA's own money (funding its share of 18-b from taxes that previously had been dedicated to MTA). (KW notes that the diversion may have started around 1996.)

### Key conclusions

-   State diversion of MTOA tax revenue for 18-b purposes first occurred in 1995-96. I am not sure yet whether diversions occurred in all subsequent years, but it appears to have occurred, at least, in 1995-96, 1995-97, and 1997-98, then again in 2001-02 and perhaps a few later years, and again in 2009-10 and probably all subsequent years. Annual **diversion amounts** were about \$150-160 million in early years. Cumulative diversions likely are \$2-3+ billion.

-   In addition the formula for 18-b payments was overriden so that total 18-b payments were less than they otherwise would have been. If the **overridden funding formula** based on number of riders and vehicle miles were used, in 2006 the maximum permitted state subsidy would have been \$444 million, \$256 million above actual. The extra state aid would require an additional \$256 million in local government assistance. (NYCIBO) We could update this.

### Capsule summary of 18-b diversion
...
Key sources: ([NYSDOT](https://www.dot.ny.gov/divisions/policy-and-strategy/public-transportation/funding-sources/STOA); NYC Comptroller -- [NYCC](https://comptroller.nyc.gov/wp-content/uploads/documents/080707-MTA_revenue_options_rpt.pdf), [NYCIBO1](https://www.ibo.nyc.ny.us/iboreports/MTAfiscal2007.pdf) and [NYCIBO2](https://www.ibo.nyc.ny.us/iboreports/mtareportaugust2011.pdf))
...
-   **1975-76**: State established its first statewide transit operating assistance program
    ...
    -   General fund appropriations administered by NYS DOT; capped by formula that involves the number of riders carried and the number of vehicle miles operated (NYSDOT, and NYCIBO1).
...
-   **1995-96**: according to NYS Assembly, first state fiscal year when state payment from general fund was reduced and 18-b funding was diverted from MTOA. Total of GF and SRF (MTOA) appropriations in SFY 1994-95, 1995-96, and 1996-97 was \$224m. In 1994-95 \$222.4m was from the GF but in 1995-96 only \$99.4m was from the GF - the other \$129.6m was diversion. In 1996-97 GF dropped to \$73m and diversion rose to \$150m. (NY Assembly LCSLR)

-   I am not yet sure exactly what happened after 1996-97.

-   **2001-02**: A NYC Comptoller report says, "From the program's inception until SFY 2001, the State appropriated its share of the 18-b aid from its General Fund". The report shows 2001-02 as the first year of the diversion. A table shows that from 1998-99 through 2000-01 the state GF paid for 18-b, not MTA taxes. (The report does not include 1997-98.) It estimates that in 2001-02 the State transferred \$161 million from the MMTOA fund to the 18-b program in lieu of General Fund dollars, reducing the amount of MMTOA funds otherwise available for transit. The \$161 million represented 77.5 percent of the State share of the downstate 18-b aid in SFY 2002. (NYCC)

-   **After 2001-02**: A blog ([this](https://nyc.streetsblog.org/2010/03/09/albany-didnt-cut-the-mta-budget-they-stole-from-it/) and [this](https://nyc.streetsblog.org/2010/03/12/fare-hike-2010-your-chance-to-prop-up-albany/)) does not mention earlier diversions and says that diversion began in fall of 2009 (presumably SFY 2009-10).

-   But the [same blog](https://nyc.streetsblog.org/2010/10/22/andrew-cuomos-transit-plan-worse-than-nothing/) also says, "Take for example, one piece of budget gimmickry started under George Pataki. The state is obligated to match local contributions to the MTA under a program called 18-b. **Starting in fiscal year 2001-2002**, the Pataki Administration stopped paying that match from the state's general fund, as it was meant to be, and started paying it out of a pool of taxes already dedicated to the MTA. According to a report by then-Comptroller William Thompson \[PDF\], that sleight-of-hand added up to a cut of between \$161 million and \$186 million each year for the MTA."

-   So perhaps the state diverted in 1995-96 and 1996-97, then did not from 1997-98 through 2000-01, and then began diverting again in 2001-02, then did not for a while, and then began diverting again in 2009-10. I can figure out exactly what was diverted and when but it requires going through a few more again.

### How much did MTA lose?

#### Loss from the diversion

-   The Assembly numbers shown earlier suggests losses of about \$130m in SFY 1995-96 and \$150m in 1996-97.

-   In 2008, NYC Comptroller analyzed the 18-b diversion and reported a loss to MTA of \$161m to \$186m annually from SFY 2002-2006:

![](images/image-1600150146.png)

NYCC notes that about \$178m of the 18-b diversion would be for MTA, if the 18-b allocation formula used in recent years to distribute program dollars to downstate operators were used to allocate the additional MMTOA funds -- report Table 3. (\$178m would be for MTA - items with \*) (NYCC)

![](images/image-195526490.png)

-   What about other years? There may have been a diversion in 1997-98. In addition, I believe there were diversions in all years after 2007-08 but I have not verified yet. Cumulative losses probably exceed \$2-3 billion.

-   In recent years state payments under 18-b have been about \$187m and disclosure says that "most" of them have been from MTOA. So I'd guess \$150-175m annually for most of the post 2007-08 period.

-   Thus diversion amounts, cumulatively, seem likely to be \$2-3+ billion.

#### Loss from overriding the formula
...
## NYS Assembly report shows drop in GF share of 18-b in 1995-96

Catalog of State and Federal Programs Aiding New York's Local Governments, June 1997, Legislative Commission on State-Local Relations, https://nyassembly.gov/Reports/Local/1997/ (Transportation at https://nyassembly.gov/Reports/Local/1997/t.htm)

Total of GF and SRF (MTOA) appropriations in SFY 1994-95, 1995-96, and 1996-97 was \$224m. In 1994-95 \$222.4m of it was from the GF but in 1995-96 only \$99.4m was from the GF - the other \$129.6m was diversion. In 1996-97 GF dropped to \$73m and diversion rose to \$150m. (NY Assembly LCSLR)

![](images/image-1982108745.png)

## MTA July 2022 financial plan

![](images/image-2027106577.png)

![](images/image-440862254.png)

![](images/image-1227961942.png)
